...
internal sealed class AndBoxedBoxedParser<TFirst, TSecond>(IParserImplementation<TFirst> First, IParserImplementation<TSecond> Second) : IParserImplementation<(TFirst First, TSecond Second)>
    where TFirst : struct
