...
internal sealed class AndRefRefParser<TFirst, TSecond>(IParserImplementation<TFirst> First, IParserImplementation<TSecond> Second) : IParserImplementation<(TFirst First, TSecond Second)>
    where TFirst : class
    where TSecond : class
{
    /// <summary>
