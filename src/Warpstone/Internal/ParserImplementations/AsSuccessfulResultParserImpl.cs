...
namespace Warpstone.Internal.ParserImplementations
{
    ...
    internal sealed class AsSuccessfulResultParserImpl<T> : ParserImplementationBase<AsSuccessfulResultParser<T>, IParseResult<T>>
    {
        private IParserImplementation<T> inner = default!;

        /// <inheritdoc />
        protected override void InitializeInternal(AsSuccessfulResultParser<T> parser, IReadOnlyDictionary<IParser, IParserImplementation> parserLookup)
        {
