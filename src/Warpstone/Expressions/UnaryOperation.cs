...
namespace Warpstone.Expressions
{
    ...
    public class UnaryOperation<TOperator, TExpression> : Operation<TOperator, TExpression>
    {
        ...
        public UnaryOperation(Associativity associativity, Dictionary<Parser<TOperator>, UnaryOperatorTransform<TOperator, TExpression>> transformations)
            : base(associativity)
        ...
        /// </summary>
        public Dictionary<Parser<TOperator>, UnaryOperatorTransform<TOperator, TExpression>> Transformations { get; }
