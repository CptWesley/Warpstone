...
namespace Warpstone.Expressions
{
    ...
    public class UnaryOperation<TOperator, TExpression> : Operation<TOperator, TExpression>
    {
        ...
        public UnaryOperation(Associativity associativity, Dictionary<IParser<object>, UnaryOperatorTransform<TOperator, TExpression>> transformations)
            : base(associativity)
        ...
        /// </summary>
        public Dictionary<IParser<object>, UnaryOperatorTransform<TOperator, TExpression>> Transformations { get; }
