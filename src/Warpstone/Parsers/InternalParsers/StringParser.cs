...
namespace Warpstone.Parsers.InternalParsers
{
    ...
    internal class StringParser : Parser<string>
    {
        ...
        public override IParseResult<string> TryParse(string input, int position)
        {
            ...
            {
                return new ParseResult<string>(this, input, position, position, new UnexpectedTokenError(new SourcePosition(input, position, position), true, new string[] { $"'{String}'" }, GetFound(input, position)), Array.Empty<IParseResult>());
            }
