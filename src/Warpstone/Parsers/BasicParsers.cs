...
public static class BasicParsers
{
    ...
    */
    ...
    /// <param name="compiled">Indicates whether or not the regular expression should be compiled. Default is <c>true</c>.</param>
    /// <returns>A parser matching a regular expression.</returns>
    public static IParser<string> Regex([StringSyntax(StringSyntaxAttribute.Regex)] string pattern, bool compiled)
        => new RegexParser(pattern, compiled);
    ...
    public static IParser<string> String(string str)
        => String(str, StringComparison.Ordinal);
