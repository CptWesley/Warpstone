//HintName: Warpstone.Sources.embedded.Internal.ParserImplementations.AndBoxedRefParserImpl.cs
...
namespace Warpstone.Internal.ParserImplementations
{
    ...
    internal sealed class AndBoxedRefParserImpl<TFirst, TSecond> : ParserImplementationBase<AndParser<TFirst, TSecond>, (TFirst First, TSecond Second)>
        where TFirst : struct
        where TSecond : class
    {
